...
import grafika4 from '../assets/Grafika4.svg';

export default function SearchSection() {
  return (
    <section id="szukaj" className="w-full py-24 px-4 md:px-12 flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-24 border-t border-gray-200">
      
      <div className="w-full max-w-md flex flex-col gap-8">
        <div className="flex flex-col gap-4">
          <h2 className="text-erasmo-purple font-black text-2xl uppercase tracking-tighter">Wymagane</h2>
        ...
        <div className="flex flex-col gap-4">
          <h2 className="text-erasmo-gray font-black text-2xl uppercase tracking-tighter">Opcjonalnie</h2>
          <div className="grid grid-cols-2 gap-3">
            <InputField label="Kraj" placeholder="np. Hiszpania" />
            <InputField label="Miasto" placeholder="np. Madryt" />
        ...
        <Link to="/wyniki" className="mt-4 w-full bg-black text-white font-bold py-4 rounded-xl hover:bg-gray-800 transition-colors uppercase tracking-[0.2em] text-sm flex items-center justify-center">
          SZUKAJ
        </Link>
      </div>
